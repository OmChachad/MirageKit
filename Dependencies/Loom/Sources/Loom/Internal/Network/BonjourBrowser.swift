...
@MainActor
public final class LoomDiscovery: ObservableObject {
    ...
    @Published public private(set) var isBrowserReady: Bool = false
    ...
    @Published public private(set) var localNetworkAccessDenied = false
