...
public actor LoomAuthenticatedSession: LoomSessionProtocol {
    ...
    public init(
        ...
        case let .quic(box):
            // QUIC connections can only be constructed on macOS 26 or newer,
            // so this case is unreachable on earlier releases.
            guard #available(macOS 26.0, *) else {
                preconditionFailure("QUIC transport requires macOS 26 or newer.")
            }
